...
> **Project-3 is the current snapshot.** It is the whole project as it stands
> after the end-effector work: the hotwire mounted on the arm for FL-01, and
> the pen tool mounted on the arm for TF-09 with the board standing vertical.
>
> `Project-2` is the same project at the earlier point, before the pen tool
> existed. Anything in Project-2 is here too — **work from this one.**
>
> What Project-3 adds:
>
> | | |
> |---|---|
> | `07_pen_tool/` | the PENTOOL component — board switch, pen TCP, reach and wrist checks |
> | `05_grasshopper/TF09_ORIENTATION.md` | why the board stands up, and the pen lean that made it reachable |
> | `05_grasshopper/TirthWork_TF09_Cell.3dm` | the pen cell in Rhino |
> | `05_grasshopper/renders_tf09/` | nine renders, one per step |
...
| **Orientation, reach and the approach switch — hotwire** | `05_grasshopper/HOTWIRE_ORIENTATION.md` |
| **Orientation, reach and the board switch — pen** | `05_grasshopper/TF09_ORIENTATION.md` |
| **Set the hotwire TCP, or flip the planes** | `06_hotwire_tool/HW_README.md` |
| **Set the pen TCP, or hang the board differently** | `07_pen_tool/PN_README.md` |
